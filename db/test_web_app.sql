...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2217691998ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test_web_app&table=contact_form">`test_web_app`.`contact_form`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=store&table=users">`store`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6a5f3d495c244e365871606b516f4955">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="store" targettable="users">
            ...
            Queried time
                            ...
                            targetdb="sistema_administrativo" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Query failed
                            ...
                            <span class="text targetdb">
            Database
                            : <span>sistema_administrativo</span>
                    </span>
                            <span class="text query_time">
            Queried time
                            : <span>During current session</span>
            ...
            Queried time
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="test_web_app" targettable="contact_form">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `test_web_app`.`contact_form` ( `id` INT NOT NULL AUTO_INCREMENT ,  `nombre` VARCHAR(50) NOT NULL ,  `primer_apellido` VARCHAR(50) NOT NULL ,  `segundo_apellido` VARCHAR(50) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test_web_app" targettable="contact_form">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `contact_form`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test_web_app" targettable="contact_form">
                            <div class="action_content">
